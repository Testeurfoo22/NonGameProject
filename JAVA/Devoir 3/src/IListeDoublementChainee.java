...
public class IListeDoublementChainee implements Serializable{
    ...
    public IListeDoublementChainee(String sens){
        this.sens = sens;
    }

    public IListeDoublementChainee(String sens, String liste, Noeud noeudInit, Noeud noeudFinal){
        this.sens = sens;
        this.liste = liste;
        this.noeudInit = noeudInit;
    ...
    public String imprimerListeDuDebut(){
        ...
        String message = "Noeuds du debut vers la fin: ";

        noeud = noeudInit;
        while (noeud.getSuivant() != null){
            message += noeud.getItem().get() + "->";
            noeud = noeud.getSuivant();
        }
        message += noeud.getItem().get();
        return message;
    ...
    public String imprimerListeDeLaFin(){
        ...
        String message = "Noeuds de la fin vers le debut: ";
