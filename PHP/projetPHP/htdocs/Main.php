    ...
    <body>
        <script>
            ...
            function mainTache(){
                ...
                getTacheData(1, COMPTE, null, null, null, 1, 1);
                getTacheData(2, COMPTE, null, null, null, 0, 1);
                getTacheData(3, COMPTE, null, null, null, 1, 0);
                getTacheData(4, COMPTE, null, null, null, 0, 0);
            }

            function getTacheData(tacheDIVId, USER, NOM, DAY, CAT, ACTIF, MESTACHES) {
                $.ajax({
                    url: 'php.php',
                    type: 'GET',
                    data: {
                    ...
                    if (TacheData && TacheData.length > 0) {
                        ...
                        $.ajax({
                            ...
                            $('#tache' + tacheDIVId).append(TacheDataHtml);
                            },
        ...
        <div id="nav">
            ...
            <!-- Ajouter la balise <a> pour contenir le logo de compte -->
        ...
        <div class="main">
            ...
            <div class="grid">
                <div id="tache1">
                    <p>Mes tâches à compléter:</p>
                </div>
                <div id="tache2">
                    <p>Mes tâches terminées:</p>
                </div>
                <div id="tache3">
                    <p>Mes tâches à compléter:</p>
                </div>
